...
import org.robor.messenger.MrzRecognizer;
...
import org.robor.messenger.SecureDocumentKey;
...
import org.robor.ui.Cells.TextDetailSettingsCell;
import org.robor.ui.Cells.TextInfoPrivacyCell;
import org.robor.ui.Cells.TextSettingsCell;
...
import org.robor.ui.Components.EmptyTextProgressView;
import org.robor.ui.Components.HintEditText;
import org.robor.ui.Components.LayoutHelper;
import org.robor.ui.Components.RadialProgress;
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(org.robor.ui.CameraScanActivity.TYPE_MRZ);
